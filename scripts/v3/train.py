...
from bdpan_sr.v3.optim import CosineAnnealingRestartLR
from bdpan_sr.v3.model import RRDBNet
from bdpan_sr.v3.dataset import SRDataset
from bdpan_sr.v3.loss import SRLoss
from bdpan_sr.v3.psnr_ssim import calculate_psnr, calculate_ssim


parser = argparse.ArgumentParser(description='sr v3')
# data config
...
def main():
    ...
    model = build_model()
    loss_func = SRLoss(step_per_epoch=3000 // args.batch_size, max_epoch=50)
