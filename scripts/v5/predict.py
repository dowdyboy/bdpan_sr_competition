...
from bdpan_sr.v5.dataset import SRTestDataset
from bdpan_sr.v5.model import PANPlus
...
def main():
    ...
    # model_chk_path = 'checkpoint/v5/best_epoch_54/model_0.pd'
    # model_chk_path = 'checkpoint/v5/best_epoch_84/model_0.pd'
    # model_chk_path = 'checkpoint/v5/best_epoch_140/model_0.pd'
    # model_chk_path = 'checkpoint/v5/best_epoch_261/model_0.pd'
    # model_chk_path = 'checkpoint/v5/best_epoch_287/model_0.pd'
    # model_chk_path = 'checkpoint/v5/best_epoch_316/model_0.pd'
    # model_chk_path = 'checkpoint/v5/best_epoch_331/model_0.pd'
    # model_chk_path = 'checkpoint/v5/best_epoch_468/model_0.pd'
    # model_chk_path = 'checkpoint/v5/best_epoch_489/model_0.pd'
    # model_chk_path = 'checkpoint/v5/best_epoch_2011/model_0.pd'
    # model_chk_path = 'checkpoint/v5/best_epoch_2047/model_0.pd'
    # model_chk_path = 'checkpoint/v5/best_epoch_2067/model_0.pd'
    # model_chk_path = 'checkpoint/v5/best_epoch_2105/model_0.pd'
    # model_chk_path = 'checkpoint/v5/last_epoch_3039/model_0.pd'
    # model_chk_path = 'checkpoint/v5/last_epoch_4031/model_0.pd'
    # model_chk_path = 'checkpoint/v5/last_epoch_5027/model_0.pd'
    # model_chk_path = 'checkpoint/v5/last_epoch_5059/model_0.pd'
    # model_chk_path = 'checkpoint/v5/best_epoch_5087/model_0.pd'
    # model_chk_path = 'checkpoint/v5/best_epoch_5113/model_0.pd'
    # model_chk_path = 'checkpoint/v5/last_epoch_5162/model_0.pd'
    # model_chk_path = 'checkpoint/v5/best_epoch_6013/model_0.pd'
    # model_chk_path = 'checkpoint/v5/best_epoch_6043/model_0.pd'
    model_chk_path = 'checkpoint/v5/last_epoch_6090/model_0.pd'
    model = build_model()
