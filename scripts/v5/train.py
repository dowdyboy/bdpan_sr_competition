...
from bdpan_sr.v5.optim import CosineAnnealingRestartLR
from bdpan_sr.v5.model import PANPlus
from bdpan_sr.v5.dataset import SRDataset
from bdpan_sr.v5.loss import SRLoss
from bdpan_sr.v5.psnr_ssim import calculate_psnr, calculate_ssim


parser = argparse.ArgumentParser(description='sr v5')
# data config
...
parser.add_argument('--img-size', type=int, default=128, help='input img size')  # 652
# optimizer config
