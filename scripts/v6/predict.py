...
from bdpan_sr.v6.dataset import SRTestDataset
from bdpan_sr.v6.model import SwinIRPlus
...
def build_model():
    # model = SwinIRPlus(img_size=768, mlp_ratio=2, embed_dim=96, up_dim=48, patch_size=2, )
    # model = SwinIRPlus(
    #     img_size=640, mlp_ratio=3, embed_dim=126, up_dim=64, patch_size=2,
    #     depths=[6, 8, 16, 6], num_heads=[3, 3, 6, 3],
    # )
    model = SwinIRPlus(img_size=424, mlp_ratio=4, embed_dim=96, up_dim=48,
                       patch_size=1, depths=[4, 6, 16, 4], num_heads=[3, 3, 6, 3], )
    return model
...
def main():
    ...
    # model_chk_path = 'checkpoint/v6/best_epoch_1/model_0.pd'
    # model_chk_path = 'checkpoint/v6/best_epoch_4/model_0.pd'
    # model_chk_path = 'checkpoint/v6/best_epoch_29/model_0.pd'
    # model_chk_path = 'checkpoint/v6/best_epoch_148/model_0.pd'
    # model_chk_path = 'checkpoint/v6/best_epoch_240/model_0.pd'
    model_chk_path = 'checkpoint/v6/best_epoch_280/model_0.pd'
    model = build_model()
